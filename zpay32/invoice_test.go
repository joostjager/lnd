		...
		},
		{
			...
			decodedInvoice: func() *Invoice {
				return &Invoice{
					...
					RouteHints:      [][]route.HopHint{testSingleHop},
				}
			},
			beforeEncoding: func(i *Invoice) {
				// Since this destination pubkey was recovered
		...
		},
		{
			...
			decodedInvoice: func() *Invoice {
				return &Invoice{
					...
					Destination:     testPubKey,
					FallbackAddr:    testRustyAddr,
					RouteHints:      [][]route.HopHint{testDoubleHop},
				}
			},
			beforeEncoding: func(i *Invoice) {
				// Since this destination pubkey was recovered
...
func compareRouteHints(a, b []route.HopHint) error {
	if len(a) != len(b) {
