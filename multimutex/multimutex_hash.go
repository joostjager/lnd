...
// HashMutex is a struct that keeps track of a set of mutexes with
// a given hash. It can be used for making sure only one goroutine
// gets given the mutex per hash.
