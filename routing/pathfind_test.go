...
func TestPathFindSpecExample(t *testing.T) {
	...
	if firstRoute.TotalTimeLock !=
		startingHeight+route.DefaultFinalCLTVDelta {
	...
	expectedTimeLock := startingHeight + daveFinalCLTV + route.DefaultFinalCLTVDelta
	...
	expectedTimeLock = startingHeight + route.DefaultFinalCLTVDelta
