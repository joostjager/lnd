...
func TestPathFindSpecExample(t *testing.T) {
	...
	if firstRoute.TotalTimeLock !=
		startingHeight+routetypes.DefaultFinalCLTVDelta {
	...
	expectedTimeLock := startingHeight + daveFinalCLTV + routetypes.DefaultFinalCLTVDelta
	...
	expectedTimeLock = startingHeight + routetypes.DefaultFinalCLTVDelta
