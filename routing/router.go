...
func (r *ChannelRouter) processSendError(paySession PaymentSession,
	rt *route.Route,
	fErr *htlcswitch.ForwardingError) *channeldb.FailureReason {
	...
	if err != nil {
		return channeldb.FailureReasonError.Ref()
	}
	...
	case *lnwire.FailUnknownPaymentHash:
		...
		return channeldb.FailureReasonIncorrectPaymentDetails.Ref()
