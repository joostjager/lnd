...
func (d *DB) AddInvoice(newInvoice *Invoice, paymentHash lnhash.Hash) (
	uint64, error) {
...
func (d *DB) SettleInvoice(paymentHash [32]byte,
	amtPaid lnwire.MilliSatoshi, preimage *lnhash.Hash) (*Invoice, error) {
...
// payment hash.
func (d *DB) CancelInvoice(paymentHash lnhash.Hash) (*Invoice, error) {
...
// error.
func (d *DB) AcceptInvoice(paymentHash lnhash.Hash,
...
func putInvoice(invoices, invoiceIndex, addIndex *bbolt.Bucket,
	i *Invoice, invoiceNum uint32, paymentHash lnhash.Hash) (
	uint64, error) {
