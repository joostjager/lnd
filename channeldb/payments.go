...
// given payment. This information is used by the router and switch to
// determine whether it is safe to resend a payment attempt, and to handle any
// errors coming back after an attempt is made. For settled payment this will
// be the information for the succeeding payment attempt.
...
// SentPayment is a wrapper around a sent payment's CreationInfo and
// AttemptInfo. All payments will have the CreationInfo and AttemptInfo set,
// while only completed payments will have a non-zero payment preimage.
