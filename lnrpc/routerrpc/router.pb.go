...
type NodeHistory struct {
	...
	LastFailTime int64 `protobuf:"varint,2,opt,name=last_fail_time,json=lastFailTime,proto3" json:"last_fail_time,omitempty"`
...
type ChannelHistory struct {
	...
	MinPenalizeAmt int64 `protobuf:"varint,3,opt,name=min_penalize_amt,json=minPenalizeAmt,proto3" json:"min_penalize_amt,omitempty"`
	/// Estimation of success probability for this channel.
	SuccessProb          float32  `protobuf:"fixed32,4,opt,name=success_prob,json=successProb,proto3" json:"success_prob,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ChannelHistory) GetMinPenalizeAmt() int64 {
	if m != nil {
		return m.MinPenalizeAmt
	}
	return 0
}
...
var fileDescriptor_7a0613f69d37b0a5 = []byte{
	...
	,
}
