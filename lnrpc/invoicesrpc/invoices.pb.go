...
func (*CancelInvoiceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_6244f4ace275af28, []int{0}
}
...
func (*CancelInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_6244f4ace275af28, []int{1}
}
...
func (*AddHoldInvoiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_6244f4ace275af28, []int{2}
}
...
func (*AddHoldInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_6244f4ace275af28, []int{3}
}
...
func init() {
	proto.RegisterFile("invoicesrpc/invoices.proto", fileDescriptor_invoices_6244f4ace275af28)
}

var fileDescriptor_invoices_6244f4ace275af28 = []byte{
