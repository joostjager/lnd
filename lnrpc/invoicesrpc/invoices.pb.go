...
func (*CancelInvoiceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_fba64a6b68223319, []int{0}
}
...
func (*CancelInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_fba64a6b68223319, []int{1}
}
...
func init() {
	proto.RegisterFile("invoicesrpc/invoices.proto", fileDescriptor_invoices_fba64a6b68223319)
}

var fileDescriptor_invoices_fba64a6b68223319 = []byte{
