...
type AddHoldInvoiceRequest struct {
	...
	//*
	//The hash of the preimage. The fields hash and preimage are mutually
	//exclusive. If neither field is specified, a random preimage will be
	//generated.
	Hash []byte `protobuf:"bytes,2,opt,name=hash,proto3" json:"hash,omitempty"`
	//*
	//The preimage for the invoice. The fields hash and preimage are mutually
	//exclusive.
...
func (m *AddHoldInvoiceRequest) GetPreimage() []byte {
	if m != nil {
		return m.Preimage
	}
	return nil
...
type SettleInvoiceMsg struct {
	...
	//*
	//Hash of the invoice to settle. This field and preimage are mutually
	//exclusive.
	Hash                 []byte   `protobuf:"bytes,2,opt,name=hash,proto3" json:"hash,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
...
func (m *SettleInvoiceMsg) GetHash() []byte {
	if m != nil {
		return m.Hash
	}
	return nil
...
var fileDescriptor_090ab9c4958b987d = []byte{
	...
	,
}
