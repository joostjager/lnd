...
func (l *channelLink) processHodlMapEvent(hodlEvent invoices.HodlEvent) error {
	...
	if err := l.processHodlEvent(hodlHtlcs, hodlEvent); err != nil {
		return err
	}
...
func (l *channelLink) processHodlEvent(htlcs []hodlHtlc,
	hodlEvent invoices.HodlEvent) error {
...
func (l *channelLink) processExitHop(pd *lnwallet.PaymentDescriptor,
	...
	err = l.processHodlEvent([]hodlHtlc{htlc}, *event)
	if err != nil {
		return false, err
	}
	return true, nil
